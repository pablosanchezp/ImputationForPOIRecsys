...
switch lower(EXPTYPE)
    case 'global'    
        ...
        geo_alpha=0.4; % the geographical influence parameter
    ...
    %-------------------------- model parameters ----------------------%            
    case 'gsslfm'              
        gsslfm.num_factors=100;
        gsslfm.epoches=150;
        gsslfm.lambda=[0.015, 0.015, 0.1];        % regularization term for group lasso    
    ...
    case 'model_eval'
        N=[200]; %changed to return 100 items
