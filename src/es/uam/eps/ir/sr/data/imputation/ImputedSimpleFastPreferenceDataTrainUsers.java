...
/***
 * Imputation preference class that will increase the number of preferences for EVERY USER in training until a percentage.
 ...
 * @param <I>
 */
public class ImputedSimpleFastPreferenceDataTrainUsers<U, I>
	...
	public ImputedSimpleFastPreferenceDataTrainUsers(FastPreferenceData<U, I> prefData,
		...
		System.out.println("ImputedSimpleFastPreferenceDataTrainUsers");
	...
	protected void imputeData(PrintStream newPreferenceData) {
		...
		this.prefData.getAllUsers().forEach(u -> {
